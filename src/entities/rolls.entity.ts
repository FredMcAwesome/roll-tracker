...
import { rollInput } from 'src/app.controller';
import { RollsRepository } from './rolls.repository';

@Entity({ customRepository: () => RollsRepository })
export class Rolls {
  [EntityRepositoryType]?: RollsRepository;
